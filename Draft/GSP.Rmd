...
There is no comprehensive YAML guide exist. However, there is a nice package called [ymlthis](https://www.youtube.com/watch?v=S-hrPH-uLSw), which provides an addin for choosing YAML specifications. 
...
You can also use biblatex if you use LaTeX. 
